...
all_three = vlan_map[1] & vlan_map[2] & vlan_map[3]
print(f'Interfaces shared by VLANS 1, 2, and 3: {all_three}')

any_vlan = {intf for intf_set in vlan_map.values() for intf in intf_set}
print(f'Interfaces that belong to at least one VLAN: {any_vlan}')

either_or = vlan_map[12] | vlan_map[13]
print(f'Interfaces that belong to either VLAN 12 or 13 or both: {either_or}')